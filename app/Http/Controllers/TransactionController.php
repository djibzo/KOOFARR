...
class TransactionController extends Controller
{
    ...
    public function foreigntransfert_traitment(Request $request)
    {
        ...
        if (!(AccountC::where('ribNumber', $ribNumber)->get()->isEmpty()) && AccountC::where('idUser', session('user')->id)->get()[0]['ribNumber']!=$ribNumber) {
            ...
            return redirect('/foreigntransfert')->with('status', 'Veuillez bien reverifier le RIB');
        }
    }
}
